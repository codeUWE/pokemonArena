		...
		<>
			<div className="w-1/2 mx-auto flex justify-center">
				<Breadcrumb
					...
					className="cursor-pointer rounded-2xl px-6 py-2 border-2"
				>
					<Breadcrumb.Item onClick={() => navigate('/')}>Home</Breadcrumb.Item>
					<Breadcrumb.Item onClick={() => navigate('/pokemon')}>
						All Pokemon
					</Breadcrumb.Item>
					<Breadcrumb.Item
			...
			<div className="w-full flex justify-center items-center">
				<div className="w-[400px] h-[600px] bg-gradient-to-b from-gray-500 via-gray-300 to-gray-500 rounded-xl flex flex-col items-center justify-center shadow-zinc-700 shadow-xl m-12 ">
					<div
					...
					>
						...
						<div className="w-[340px] h-[170px] border-2 border-zinc-800 mx-auto mt-3 format ps-2 flex flex-col justify-between items-center p-4">
							...
							<div className="flex space-x-2">
								<Button
									onClick={() => navigate(`/pokemon/${singlePokemon.id}/name`)}
									className="bg-zinc-800 text-orange-200 px-4 rounded-3xl border-none"
								>
									Name
								</Button>
								<Button
									onClick={() => navigate(`/pokemon/${singlePokemon.id}/type`)}
									className="bg-zinc-800 text-pink-300 px-4 rounded-3xl border-none"
								>
									Type
								</Button>
								<Button
									onClick={() => navigate(`/pokemon/${singlePokemon.id}/base`)}
